    ...
    <div class="login">
      <dl>
        ...
        <dd><label for="password">密 码：</label>
        	<input type="password" name="password" class="inputh" value="${password}" id="password"/></dd>
        <dd>
           <label class="lf" for="passwords">验证码：</label>
           <input type="text" name="inputCode" class="inputh inputs lf" value="" id="passwords"/>
          
           <span class="wordp lf">
                 <img id="validateCode" src="jsp/Number.jsp" width="96" height="27" alt="" />
           </span>
        ...
        <dd class="buttom">
           ...
           <input id="register" onclick="javascript:location='${pageContext.request.contextPath}/jsp/register.jsp'" type="button" value="注 册" class="spbg buttombg f14 lf" />
